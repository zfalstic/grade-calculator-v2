    ...
    <div>
      ...
      <div className='navigation'>
        <div className='navigation__text-container'>
          <p className='navigation__text'>If you want to calculate your average in a class by entering each grade</p>
          <p className='navigation__text'>If you want to calculate what you need to make on your final to hit a target grade</p>
        </div>
